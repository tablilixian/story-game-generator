...
2. 【忠于原著】对于原著中已有的原始对话，必须原样保留，不得修改或删除；只有在原著中没有明确写明的对话，才可以根据剧情需要和人物性格进行适度的创造性补充。
3. 【背景描述】根据叙事需要，适时添加画外音、场景说明或旁白，以增强故事的背景交代和情感氛围，使观众更好地理解情境和人物内心。
4. 优化情节结构，确保事件发展具有清晰的因果关系，逻辑严密。
5. 增强场景之间的衔接与转换，使整体叙事流畅自然。
6. 丰富和提升人物对话，使其更具个性、情感色彩和真实感，避免生硬或刻板。
7. 强化戏剧冲突，突出人物之间的矛盾与情感张力，增加情节的吸引力和感染力。
8. 深化人物内心活动和情感描写，提升剧本的情感深度。
9. 优化整体节奏，合理分配高潮与缓和段落，避免情节拖沓或推进过快。
10. 保持或适度增加剧本内容长度，确保内容充实但不过度冗长。
11. 严格遵循剧本格式规范，包括场景标注、人物台词、舞台指示等。
12. 输出语言为：${language}，确保语言风格与剧本类型相符。
